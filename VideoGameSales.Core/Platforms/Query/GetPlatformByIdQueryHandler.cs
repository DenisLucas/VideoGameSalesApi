...
{
    public class GetPublisherByIdQueryHandler : IRequestHandler<GetPlatformByIdQuery, IsValid<PlatformViewModel>>
    {
        ...
        public async Task<IsValid<PlatformViewModel>> Handle(GetPlatformByIdQuery request, CancellationToken cancellationToken)
        {
