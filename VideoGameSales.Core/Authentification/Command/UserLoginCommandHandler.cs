...
namespace VideoGameSales.Core.Authentification.Command
{
    public class UserLoginCommandHandler
    {
        ...
        public UserLoginCommandHandler(UserManager<IdentityUser> userManager, JwtSettings jwtSettings)
        {
            _userManager = userManager;
            _jwtSettings = jwtSettings;
        }
        public async Task<AuthentificationResult> Handle(UserLoginCommand request)
        {
