    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishersToGames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublishersToGames_Games_Publishers_id",
                        column: x => x.Publishers_id,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishersToGames_Publishers_Publishers_id",
                        column: x => x.Publishers_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublishersToGames_Publishers_id",
                table: "PublishersToGames",
